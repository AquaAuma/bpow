...
seafloor_meow_deepsea <- st_read(paste0(general_path, "input/provinces_p7s3.shp"))

# load holes shapefile
holes <- st_read(paste0(general_path, "input/holes_p6s2_correct.shp")) %>% 
  st_cast("POLYGON") %>% 
...
depth_n0_s90_w180_e90 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n0.0_s-90.0_w-180.0_e-90.0.asc"))
depth_n0_s90_w90_e0 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n0.0_s-90.0_w-90.0_e0.0.asc"))
depth_n0_s90_w0_e90 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n0.0_s-90.0_w0.0_e90.0.asc"))
depth_n0_s90_w90_e180 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n0.0_s-90.0_w90.0_e180.0.asc"))
depth_n90_s0_w180_e90 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n90.0_s0.0_w-180.0_e-90.0.asc"))
depth_n90_s0_w90_e0 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n90.0_s0.0_w-90.0_e0.0.asc"))
depth_n90_s0_w0_e90 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n90.0_s0.0_w0.0_e90.0.asc"))
depth_n90_s0_w90_e180 <- raster(paste0(general_path, "input/gebco_2020_ascii/gebco_2020_n90.0_s0.0_w90.0_e180.0.asc"))
...
for(h in 801:1000) {
  ...
  if(length(select_depth)>0){
    ...
    if(nrow(select_polygons)==1){
      ...
      #save(seafloor_meow_deepsea_filled, file = paste0(general_path, "output/results_fill_holes_",part,".RData"))
      #save.image(paste0(general_path, "output/envt_",part,".RData"))
      print("One polygon")
    }
  ...
  save(seafloor_meow_deepsea_filled, file = paste0(general_path, "output/seafloor_meow_deepsea_filled_",part,".RData"))
  save.image(paste0(general_path, "output/envt_",part,".RData"))}