...
-   Step \#2: The validity of geometries was checked with the command "Check validity" of QGIS `Vector → Geometry Tools → Check Validity → Input Layer: BATHYAL/ABYSSAL`
    ...
    ![](figures/self_intersection_4.png){width="539"}
...
-   Step \#1: identification of areas: off the Florida coast, because the threshold of 800m is arbitrary and this is a "transition" zone
    ...
    ![](figures/irregularities.png){width="408"}
...
-   Step \#2: For each identified ecoregion from Step \#1, we use the corresponding depth raster from GEBCO to identify trenches (below 6,500m deep) and create new polygons from there. For instance, on the figure below, the ecoregions from provinces_p5s2 include deep area on the northern sites.

    ![](figures/select_hadal_1.png){width="263"} ![](figures/select_hadal_2.png){width="198"}
...
-   Step \#1:
    ...
    ![](figures/3D-NNA_1.png){width="179"} ![](figures/3D-NNA_2.png){width="198"} ![](figures/3D-NNA_3.png){width="213"}
